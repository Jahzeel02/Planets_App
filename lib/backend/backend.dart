...
import 'schema/holes_record.dart';
...
export 'schema/holes_record.dart';
...
/// Functions to query HolesRecords (as a Stream and as a Future).
Stream<List<HolesRecord>> queryHolesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      HolesRecord.collection,
...
Future<List<HolesRecord>> queryHolesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<HolesRecord>> queryHolesRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
